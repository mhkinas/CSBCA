...
--
-- Table structure for table `csbc_code_type`
--

DROP TABLE IF EXISTS `csbc_code_type`;
...
--
-- Dumping data for table `csbc_code_type`
--

LOCK TABLES `csbc_code_type` WRITE;
/*!40000 ALTER TABLE `csbc_code_type` DISABLE KEYS */;
INSERT INTO `csbc_code_type` VALUES (1,'javascript'),(2,'css'),(3,'HTML'),(4,'XML'),(5,'other');
