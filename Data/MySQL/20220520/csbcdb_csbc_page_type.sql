...
--
-- Table structure for table `csbc_page_type`
--

DROP TABLE IF EXISTS `csbc_page_type`;
...
--
-- Dumping data for table `csbc_page_type`
--

LOCK TABLES `csbc_page_type` WRITE;
/*!40000 ALTER TABLE `csbc_page_type` DISABLE KEYS */;
INSERT INTO `csbc_page_type` VALUES (2,'info'),(1,'main'),(4,'menu'),(3,'normal');
