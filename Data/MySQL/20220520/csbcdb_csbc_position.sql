...
--
-- Table structure for table `csbc_position`
--

DROP TABLE IF EXISTS `csbc_position`;
...
--
-- Dumping data for table `csbc_position`
--

LOCK TABLES `csbc_position` WRITE;
/*!40000 ALTER TABLE `csbc_position` DISABLE KEYS */;
INSERT INTO `csbc_position` VALUES (5,'buttom'),(1,'center'),(6,'dene01'),(2,'left'),(3,'right'),(4,'top');
