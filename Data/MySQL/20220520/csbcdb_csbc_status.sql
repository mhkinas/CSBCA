...
--
-- Table structure for table `csbc_status`
--

DROP TABLE IF EXISTS `csbc_status`;
...
--
-- Dumping data for table `csbc_status`
--

LOCK TABLES `csbc_status` WRITE;
/*!40000 ALTER TABLE `csbc_status` DISABLE KEYS */;
INSERT INTO `csbc_status` VALUES (3,'Active'),(4,'Passive');
