...
--
-- Table structure for table `csbc_file_type`
--

DROP TABLE IF EXISTS `csbc_file_type`;
...
--
-- Dumping data for table `csbc_file_type`
--

LOCK TABLES `csbc_file_type` WRITE;
/*!40000 ALTER TABLE `csbc_file_type` DISABLE KEYS */;
INSERT INTO `csbc_file_type` VALUES (7,'csv'),(8,'dnm01'),(4,'excel'),(1,'image'),(6,'json'),(5,'other'),(2,'pdf'),(3,'word');
