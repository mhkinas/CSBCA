...
{
    public class MessageMapParams : BaseParameters
    {
        public new void initParams()
        {
            ...
            isDebug = true;
            tableNames = new string[] { "csbc_message_map", "vt_csbc_message_map" };
            ...
            orderBy = "message_map_id";
            refTableNames = new string[] { "vt_csbc_message", "vt_csbc_group", "vt_csbc_user" };
        ...
        public void setLabels()
        {
            ...
            {
                pageTitle = "Message Map";
                pageName = "/user/message-map";
