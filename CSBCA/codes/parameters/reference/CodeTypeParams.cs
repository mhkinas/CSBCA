...
{
    public class CodeTypeParams : BaseParameters
    {
        public new void initParams()
        {
            ...
            isDebug = true;
            tableNames = new string[] { "csbc_code_type", "vt_csbc_code_type" };
