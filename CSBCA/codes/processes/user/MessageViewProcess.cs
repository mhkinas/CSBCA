...
{
    public class MessageViewProcess : BaseProcess
    {
        public new MessageViewParams p = null;
        public string codeStrMW90 = null, codeStrBW = null;

        public void initProcess(IHttpContextAccessor httpContextA, MessageViewParams p)
        {
            this.p = p;
