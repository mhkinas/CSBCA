...
namespace CSBCA.codes.processes
{
    ...
    {
        public new MessageParams p = null;
        public string codeStrMW90 = null, codeStrBW = null;
        public void initProcess(IHttpContextAccessor httpContextA, MessageParams p)
        {
            this.p = p;
        ...
        public new string doPost()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        p.formData[formSize - 2] = request.Form[p.fieldNames[formSize - 2]].ToString();
                        ...
                        {
                            p.formData[3] = new StatusBean(p.runDB, "csbc_status", null, null, "status_name").getStatus("2", true, null);
                    ...
                    if (dbQuery)
                    {
                        ...
                        if (!isInsert)
                        {
                            if (p.tableData[0] != null && p.tableData[0][6] != null)
                                p.tableData[0][6] = p.dateFormatter.changeDateFormat(p.tableData[0][6]);
                            else
