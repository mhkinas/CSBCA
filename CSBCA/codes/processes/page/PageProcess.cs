...
{
    public class PageProcess : BaseProcess
    {
        public new PageParams p = null;
        public void initProcess(IHttpContextAccessor httpContextA, PageParams p)
        {
            this.p = p;
        ...
        public new string doGet()
        {
            ...
            try
            {
                ...
                if (isDebug) Console.WriteLine("p.sideBarName: " + p.sideBarName[0][0] + ", p.menuName :" + p.menuName[0][0]);
