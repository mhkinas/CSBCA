...
{
    public class PageLinkProcess : BaseProcess
    {
        public new PageLinkParams p = null;
        public void initProcess(IHttpContextAccessor httpContextA, PageLinkParams p)
        {
            this.p = p;
                    ...
                    if (dbQuery)
                    {
                        ...
                        if (!isInsert)
                        {
                            if (p.tableData[0] != null && p.tableData[0][7] != null)
                                p.tableData[0][7] = p.dateFormatter.changeDateFormat(p.tableData[0][7]);
                            else
