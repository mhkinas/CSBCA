...
{
    public class log_tableModel : PageModel
    {
        public LogTableParams p = null;
        LogTableProcess process = null;
        ...
        public IActionResult OnPost() //
        {
            ...
            try
            {
                if (process == null) process = new LogTableProcess();
