...
{
    public class log_formModel : PageModel
    {
        public LogFormParams p = null;
        LogFormProcess process = null;
        ...
        public IActionResult OnPost() //
        {
            ...
            try
            {
                if (process == null) process = new LogFormProcess();
