...
{
    public class log_typeModel : PageModel
    {
        public LogTypeParams p = null;
        LogTypeProcess process = null;
        ...
        public IActionResult OnPost() //
        {
            ...
            try
            {
                if (process == null) process = new LogTypeProcess();
