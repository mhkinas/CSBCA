...
{
    public class file_typeModel : PageModel
    {
        public FileTypeParams p = null;
        FileTypeProcess process = null;
        ...
        public IActionResult OnPost() //
        {
            ...
            try
            {
                if (process == null) process = new FileTypeProcess();
