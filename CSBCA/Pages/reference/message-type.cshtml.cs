...
{
    public class message_typeModel : PageModel
    {
        public MessageTypeParams p = null;
        MessageTypeProcess process = null;
        ...
        public string jsObjData = null, pageName = null, pageTitle = null, errorString = null, qsql = null,
                      qsql2 = null, menuString = null, leftSideStr = null, messageString = null, excelCols = null;
        ...
        public void OnGet()
        {
            try
            {
                process = new MessageTypeProcess();
        ...
        public IActionResult OnPost() //
        {
            ...
            try
            {
                if (process == null) process = new MessageTypeProcess();
