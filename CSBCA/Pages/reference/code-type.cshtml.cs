...
{
    public class code_typeModel : PageModel
    {
        public CodeTypeParams p = null;
        CodeTypeProcess process = null;
        ...
        public IActionResult OnPost() //
        {
            ...
            try
            {
                if (process == null) process = new CodeTypeProcess();
