...
{
    public class page_typeModel : PageModel
    {
        public PageTypeParams p = null;
        PageTypeProcess process = null;
        ...
        public IActionResult OnPost() //
        {
            ...
            try
            {
                if (process == null) process = new PageTypeProcess();
