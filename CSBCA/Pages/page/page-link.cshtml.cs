...
{
    public class page_linkModel : PageModel
    {
        public PageLinkParams p = null;
        PageLinkProcess process = null;
        ...
        public IActionResult OnPost() //JsonResult
        {
            ...
            try
            {
                if (process == null) process = new PageLinkProcess();
