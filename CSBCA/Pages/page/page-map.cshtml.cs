...
{
    public class page_mapModel : PageModel
    {
        public PageMapParams p = null;
        PageMapProcess process = null;
        ...
        public IActionResult OnPost() //JsonResult
        {
            ...
            try
            {
                if (process == null) process = new PageMapProcess();
