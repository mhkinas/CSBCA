...
namespace CSBCA.Pages.file
{
    public class FileModel : PageModel
    {
        public FileParams p = null;
        ...
        public IActionResult OnPost() //JsonResult
        {
            ...
            try
            {
                if (process == null) process = new FileProcess();
                ...
                {
                    if (p.isDebug) Console.WriteLine("download is begun01!");
                    ...
                    if (buffer != null)
                    {
                        ...
                        if (p.isDebug) Console.WriteLine("strBuffer:" + strBuffer);

                        return File(buffer, "application/octet-stream", p.fieldNames[1]);//fileSResult;
                    }
                    else
                    {
                        if (p.isDebug) Console.WriteLine("fileStream is null!");
                        return null;
                    }
                }
                else
