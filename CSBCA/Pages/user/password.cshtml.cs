...
namespace CSBCA.Pages.user
{
    ...
    {
        public PasswordChangeParams p = null;
        PasswordChangeProcess process = null;
        ...
        public void OnGet()
        {
            try
            {
                process = new PasswordChangeProcess();
            ...
            {
                errorString = "onGet Error : " + ex.Message;
        ...
        public IActionResult OnPost() //
        {
            ...
            try
            {
                if (process == null) process = new PasswordChangeProcess();
