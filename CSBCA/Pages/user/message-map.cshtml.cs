...
{
    public class message_mapModel : PageModel
    {
        public MessageMapParams p = null;
        MessageMapProcess process = null;
        ...
        public IActionResult OnPost() //JsonResult
        {
            ...
            try
            {
                if (process == null) process = new MessageMapProcess();
