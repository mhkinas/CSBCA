...
namespace CSBCA.Pages.user
{
    public class message_viewModel : PageModel
    {
        public MessageViewParams p = null;
        MessageViewProcess process = null;
        ...
        public string jsObjData = null, pageName = null, pageTitle = null, errorString = null, qsql = null,
                      ...
                      codeStrMW90 = null, codeStrBW = null, excelCols = null;
        ...
        public void OnGet()
        {
            try
            {
                process = new MessageViewProcess();
                ...
                else
                {
                    ...
                    codeStrMW90 = process.codeStrMW90;
                    codeStrBW = process.codeStrBW;
                }
                p = process.p;
        ...
        public IActionResult OnPost() //JsonResult
        {
            ...
            try
            {
                if (process == null) process = new MessageViewProcess();
