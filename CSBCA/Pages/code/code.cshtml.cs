...
namespace CSBCA.Pages.code
{
    ...
    {
        public CodeParams p = null;
        CodeProcess process = null;
        ...
        public IActionResult OnPost() //JsonResult
        {
            ...
            try
            {
                if (process == null) process = new CodeProcess();
                ...
                if (p.action.Equals("download"))
                {
                    ...
                    if (buffer != null)
                    {
                        return File(buffer, "application/octet-stream", p.fieldNames[1]);
                    }
                    else
                    {
